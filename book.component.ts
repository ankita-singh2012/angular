...
export class BookComponent {
  ...
  this.bookForm=this.formBuilder.group({
    ...
    title:['Irodov',[Validators.required,Validators.minLength(3)]],
    author:this.formBuilder.group({

      name:['Ankita',[Validators.required, Validators.minLength(5), Validators.maxLength(15)]],
      email:['rajputsinghbabuni@gmail.com',[Validators.required, Validators.email]]
